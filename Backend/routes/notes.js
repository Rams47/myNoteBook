...
router.put('/updatenote/:id', fetchuser,
   async (req, res) => {
      ...
      try {
         ...
         //checking if user want having this id
         if (note.user.toString() !== req.user.id) {
            return res.status.send("Not Allowed");
         }
...
//ROUTE 4: Delet exiting note using: DELETE "/api/notes/updatenote". login required
router.delete('/deletenote/:id', fetchuser,
   async (req, res) => {
      ...
      try {
         ...
         //checking if user want delete having this id
         if (note.user.toString() !== req.user.id) {
            return res.status.send("Not Allowed");
         }
